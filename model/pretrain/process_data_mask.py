...
if __name__ == '__main__':
    ...
    process_data('./data/codesearchnet/per_all_mask_train.json', './data/codesearchnet/mask_train.pkl')
    process_data('./data/codesearchnet/per_all_mask_test.json', './data/codesearchnet/mask_test.pkl')
    process_data('./data/codesearchnet/per_all_mask_valid.json', './data/codesearchnet/mask_valid.pkl')
    
    process_data('./data/code2seq/per_all_mask_train.json', './data/code2seq/mask_train.pkl')
    process_data('./data/code2seq/per_all_mask_test.json', './data/code2seq/mask_test.pkl')
    process_data('./data/code2seq/per_all_mask_valid.json', './data/code2seq/mask_valid.pkl')
